...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/helder/projects/personal/rest-api-prisma-oak/generate/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "generate/client/libquery_engine-debian-openssl-1.1.x.so.node")
